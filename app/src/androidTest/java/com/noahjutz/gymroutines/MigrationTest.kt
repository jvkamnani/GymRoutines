...
class MigrationTest {
    ...
    fun migrate35To36() {
        var db =
            helper.createDatabase(TEST_DB, 35).use {
                it.execSQL(
    ...
    fun migrate36To37() {
        var db =
            helper.createDatabase(TEST_DB, 36).use {
                it.execSQL(
                    "INSERT INTO exercise_table VALUES ('Squat', '', 'true', 'true', 'false', 'false', 'false', 0)",
                )
                it.execSQL(
    ...
    fun migrate37to38() {
        var db =
            helper.createDatabase(TEST_DB, 37).use {
                it.execSQL(
                    "INSERT INTO exercise_table VALUES ('Squat', '', 'true', 'true', 'false', 'false', 'false', 0)",
                )
                it.execSQL(
    ...
    fun migrate38to39() {
        var db =
            helper.createDatabase(TEST_DB, 38).use {
    ...
    fun migrate39to40() {
        var db =
            helper.createDatabase(TEST_DB, 39).use {
                it.execSQL("INSERT INTO routine_table VALUES ('Legs', 0)")
                it
            }
    ...
    fun migrate40to41() {
        var db =
            helper.createDatabase(TEST_DB, 40).use {
    ...
    fun migrate41to42() {
        var db =
            helper.createDatabase(TEST_DB, 41).use {
                it.execSQL("INSERT INTO routine_table VALUES ('Full Body', 0)")
                it.execSQL(
                    "INSERT INTO exercise_table VALUES ('Squat', '', 'true', 'true', 'false', 'false', 'false', 0)",
                )
    ...
    fun migrate42to43() {
        var db =
            helper.createDatabase(TEST_DB, 42).use {
